...
if __name__ == '__main__':
    ...
    # Build the model.
    model = LSTMClassifier(args.embedding_dim, args.hidden_dim,args.num_layers,args.vocab_size).to(device)

    with open(os.path.join(args.data_dir, "word_dict.pkl"), "rb") as f:
        model.word_dict = pickle.load(f)

    print("Model loaded with embedding_dim {}, hidden_dim {}, num_layers {} , vocab_size {}.".format(
        args.embedding_dim, args.hidden_dim,args.num_layers, args.vocab_size
    ))
